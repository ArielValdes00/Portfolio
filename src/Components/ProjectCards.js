...
const ProjectCards = ({ image, title, description, icons, dataAos, repositoryLink, deployLink, dataAosDelay }) => {
    return (
        <div className="bg-neutral-800 rounded-lg w-[80%] sm:w-[60%] md:w-[40%] lg:w-[33%] pb-3" data-aos={dataAos} data-aos-duration={"1000"} data-aos-delay={dataAosDelay}>
            <div>
            ...
            <div className="flex flex-col xl:gap-1 text-gray-100 items-center">
                <h3 className="text-2xl xl:text-3xl text-white font-semibold mt-2 mb-1">{title}</h3>
